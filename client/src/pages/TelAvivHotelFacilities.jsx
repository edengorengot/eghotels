        ...
        <>
            ...
            <div className="main container">
                <section className="center">
                    <h2>Our hotel facilities at EG Tel Aviv</h2>
                        ...
                        <div className="col-12 col-md-4">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        The EG Tel Aviv features an advanced, fully equipped fitness center, offering effective and fun workouts to maintain or improve your fitness while on vacation.
                        ...
                        <div className="col-12 col-md-4">
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        Enter a magical world at the EG Tel Aviv Kids Club, where every corner is packed with fun activities just for kids: storytime, arts & crafts workshops, toddlers' corner, puppet shows, computer games, toys, and more.
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default TelAvivHotelFacilities;